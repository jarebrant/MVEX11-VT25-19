...
epsilon_schedule = pyabc.QuantileEpsilon(initial_epsilon=0.35, alpha= 0.8, quantile_multiplier=1)
sampler = pyabc.sampler.MulticoreEvalParallelSampler()
abc = pyabc.ABCSMC(model, prior, distance, population_size=10 ,eps = epsilon_schedule ,sampler=sampler, acceptor=acceptor)
